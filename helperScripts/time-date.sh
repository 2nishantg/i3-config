...
(
echo "
^fg(#424b44)^fn(Inconsolata:bold:size=11)Time & Date
"
echo "$cal_p_m
"
echo "$cal_c_m
...
) | dzen2 -p -x 1867 -y 1054 -w 335 -bg $BG -fg $FG -l 33 -sa c -ta c -e 'onstart=uncollapse;button1=exit;button3=exit' -fn $font1
